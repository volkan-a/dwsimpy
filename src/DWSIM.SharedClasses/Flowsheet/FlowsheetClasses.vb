...
Namespace DWSIM.Flowsheet
    ...
    <System.Serializable()> Public Class FlowsheetVariables
        ...
        Public PetroleumAssays As Dictionary(Of String, Object)
        ...
        Sub New()
            ...
            PetroleumAssays = New Dictionary(Of String, Object)
        ...
        Public Property CurrentWeather As IWeatherData = New Global.DWSIM.SharedClasses.WeatherData Implements IFlowsheetOptions.CurrentWeather
                ...
                For Each item In extraprops
                    Try
                        .Item(.Count - 1).Add(New XElement("Property",
                                                           ...
                                                           New XElement("Data", System.Text.Json.JsonSerializer.Serialize(item.Value, item.Value.GetType()))}))
            ...
            If Not xel_d Is Nothing Then
                ...
                For Each xel As XElement In dataDyn
                    Try
                        ...
                        Dim propval = System.Text.Json.JsonSerializer.Deserialize(xel.Element("Data").Value, ptype)
